...
@param count
'''
def get4hHistoryPrice(coinType,count):
    if coinType == 1:
        url = HUOBI_STATICMARKET + "/btc_kline_060_json.js"
    elif coinType == 2:
        url = HUOBI_STATICMARKET + "/ltc_kline_060_json.js"
    else:
        return None
...
@param coinType
'''
def getCurrentPrice(coinType):
    if coinType == 1:
        url = HUOBI_STATICMARKET + "/ticker_btc_json.js"
    elif coinType == 2:
        url = HUOBI_STATICMARKET + "/ticker_ltc_json.js"
    else:
        return None
